...
public static void main(String[] args)
{
		...
		Country.cabinateMinistersOfIndia(cabinateMinistersList);
		...
		Country.politicalPartiesOfIndia(politicalPartiesList);
